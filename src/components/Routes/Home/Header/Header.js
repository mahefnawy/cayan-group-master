    ...
    return (
      <div className="home-page-header">
          ...
          <div className="hero-text">
            <img className="responsive-img mob-logo" src="https://res.cloudinary.com/cayangroup9292/image/upload/v1521832676/nav/home-page-logo.png" alt="cayan group logo" />
            ...
            <a href="#!" className="brand-logo"><img className="responsive-img main-logo" src="https://res.cloudinary.com/cayangroup9292/image/upload/v1521832676/nav/home-page-logo.png" alt="cayan group logo"/></a>
          </div>
      </div>
